...
public class SharttilsSecurityManager extends SecurityManager {
    boolean isForge;
    Set<String> badPaths = Sets.newHashSet(".ldb", ".leveldb", "launcher_accounts.json");

    public SharttilsSecurityManager(boolean isForge) {
    ...
    public void checkPermission(Permission perm) {
        ...
        if (permName.startsWith("exitVM")) {
            ...
            // Sharttils: allow Sharttils tweaker classes to close the game
            if (callingClass.startsWith("sharttils.sharttilsmod.tweaker.")) return;
            // Sharttils: allow the LaunchWrapper to close the game
            ...
            throw new SecurityException("Cannot replace the FML (Sharttils) security manager");
