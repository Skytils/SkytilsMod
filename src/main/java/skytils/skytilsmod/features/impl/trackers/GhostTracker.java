...
public class GhostTracker {
  ...
  public void onChat(ClientChatReceivedEvent event) {
    String message =
        StringUtils.stripControlCodes(event.message.getUnformattedText());
    if (Skytils.config.GhostTracker && Utils.inMist &&
        message.startsWith("RARE DROP! ") && !message.contains(":")) {
  ...
  static { new GhostTrackerElement(); }
  ...
  public static class GhostTrackerElement extends GuiElement {
    ...
    public void render() {
      ...
      if (this.getToggled() && player != null && world != null &&
          Utils.inMist) {
