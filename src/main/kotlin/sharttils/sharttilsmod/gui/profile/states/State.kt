...
package sharttils.sharttilsmod.gui.profile.states
...
open class alwaysUpdateMappedState<T, U>(initialState: State<T>, private val mapper: (T) -> U) : alwaysUpdateState<U>(mapper(initialState.get())) {
