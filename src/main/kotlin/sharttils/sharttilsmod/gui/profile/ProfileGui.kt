...
package sharttils.sharttilsmod.gui.profile
...
import sharttils.hylin.extension.getLatestSkyblockProfile
import sharttils.hylin.extension.nonDashedString
import sharttils.hylin.player.Player
import sharttils.hylin.skyblock.Member
import sharttils.hylin.skyblock.Profile
import sharttils.hylin.skyblock.Skills
import sharttils.sharttilsmod.Sharttils
import sharttils.sharttilsmod.Sharttils.Companion.hylinAPI
import sharttils.sharttilsmod.gui.constraints.FixedChildBasedRangeConstraint
import sharttils.sharttilsmod.gui.profile.components.*
import sharttils.sharttilsmod.gui.profile.states.alwaysMap
import sharttils.sharttilsmod.gui.profile.states.alwaysUpdateState
...
class ProfileGui(uuid: UUID, name: String) : WindowScreen(ElementaVersion.V1, drawDefaultBackground = false) {
    ...
    private val logo by UIImage.ofResourceCached("/assets/sharttils/logo.png").constrain {
        x = 2.5.pixels
        y = CenterConstraint()
        width = 20.pixels
    ...
    private val navText by UIText("${if (Utils.isBSMod) "BSMod" else "Sharttils"} Profile Viewer").constrain {
