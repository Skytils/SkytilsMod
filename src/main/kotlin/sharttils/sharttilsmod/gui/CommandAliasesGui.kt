...
import sharttils.sharttilsmod.features.impl.handlers.CommandAliases
...
class CommandAliasesGui : WindowScreen(ElementaVersion.V1, newGuiScale = 2), ReopenableGUI {
    ...
    init {
        ...
        val tooltipBlock = UIBlock().constrain {
            ...
            .addChild(UIWrappedText("What are aliases? Aliases are little shortcuts for commands. For example, /slay could be short for /sharttilsslayer. Want to give it a try? Click 'Add Alias', enter 'slay' for 'Alias Name' and 'sharttilsslayer' as the executed command! Then, run the command /slay Sychic! Aliases will also append any arguments that you supply.").constrain {
