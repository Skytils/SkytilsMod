...
import sharttils.sharttilsmod.core.structure.LocationButton
import sharttils.sharttilsmod.core.structure.ResizeButton
import sharttils.sharttilsmod.core.structure.ResizeButton.Corner
...
open class LocationEditGui : GuiScreen(), ReopenableGUI {
    ...
    override fun initGui() {
        for ((_, value) in Sharttils.guiManager.elements) {
