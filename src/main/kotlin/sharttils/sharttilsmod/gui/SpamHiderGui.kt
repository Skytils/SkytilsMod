...
import sharttils.sharttilsmod.gui.components.AccordionComponent
import sharttils.sharttilsmod.gui.components.CustomFilterComponent
import sharttils.sharttilsmod.gui.components.RepoFilterComponent
...
class SpamHiderGui : WindowScreen(ElementaVersion.V1, newGuiScale = 2) {
    ...
    val configHiders = Sharttils.config.getCategories()
        .flatMap { category ->
    ...
    init {
        ...
        val demoToast = UIImage.ofResource("/assets/sharttils/gui/toast.png")
            .constrain {
                x = CenterConstraint()
                y = SiblingConstraint()
                width = 160.pixels()
        ...
        UIImage.ofResource("/assets/sharttils/toasts/revive.png")
            .constrain {
                x = 8.pixels()
                y = 8.pixels()
                width = 16.pixels()
        ...
        Sharttils.config.getCategories()
            .flatMap { category ->
                category.items.filter { item ->
