...
import sharttils.sharttilsmod.utils.ensureFile
import java.io.File
...
abstract class PersistentSave(protected val saveFile: File, private val interval: Long = 30_000) {
    ...
    protected val gson: Gson = Sharttils.gson
    protected val mc: Minecraft = Sharttils.mc
    ...
    companion object {
        ...
        init {
            ...
            }, "Sharttils-PersistentSave-Shutdown"))
        }
    }
}
