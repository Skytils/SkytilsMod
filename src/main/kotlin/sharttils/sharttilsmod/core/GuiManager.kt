...
import sharttils.sharttilsmod.gui.LocationEditGui
import sharttils.sharttilsmod.utils.GlState
import sharttils.sharttilsmod.utils.Utils
import sharttils.sharttilsmod.utils.toasts.GuiToast
import java.io.File
import java.io.InputStreamReader
import java.io.OutputStreamWriter

class GuiManager : PersistentSave(File(Sharttils.modDir, "guipositions.json")) {
    ...
    fun renderPlayerInfo(event: RenderGameOverlayEvent.Post) {
        if (Sharttils.usingLabymod && Minecraft.getMinecraft().ingameGUI !is GuiIngameForge) return
    ...
    fun renderPlayerInfoLabyMod(event: RenderGameOverlayEvent) {
        if (!Sharttils.usingLabymod) return
    ...
    fun onRenderHUD(event: RenderHUDEvent) {
        ...
        mc.mcProfiler.startSection("SharttilsHUD")
