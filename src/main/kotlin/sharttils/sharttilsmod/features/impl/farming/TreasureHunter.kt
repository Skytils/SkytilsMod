...
class TreasureHunter {
    ...
    fun onChat(event: ClientChatReceivedEvent) {
        ...
        if (Sharttils.config.treasureHunterSolver && formatted.startsWith("§e[NPC] Treasure Hunter§f: ")) {
            ...
            if (solution != null) {
                ...
                UChat.chat("§aSharttils will track your treasure located at: §b(${solution.x},${solution.y},${solution.z})")
            }
        }
    }
