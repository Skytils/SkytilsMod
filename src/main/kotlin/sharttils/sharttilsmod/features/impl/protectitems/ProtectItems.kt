 ...
 */
package sharttils.sharttilsmod.features.impl.protectitems
...
import sharttils.sharttilsmod.events.impl.ItemTossEvent
...
class ProtectItems {
    ...
    private fun notifyStopped(event: Event?, action: String) {
        ...
        UChat.chat("§cSharttils has stopped you from $action that item!")
        event?.isCanceled = true
    }
