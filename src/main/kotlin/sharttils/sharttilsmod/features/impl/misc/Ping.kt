...
import sharttils.sharttilsmod.mixins.transformers.accessors.AccessorServerListEntryNormal
...
import sharttils.sharttilsmod.utils.hasMoved
    ...
    class PingDisplayElement : GuiElement(name = "Ping Display", fp = FloatPair(10, 10)) {
        override fun render() {
            if (Utils.isOnHypixel && toggled && mc.thePlayer != null) {
                when (Sharttils.config.pingDisplay) {
                    1 -> {
        ...
        override val toggled: Boolean
            get() = Sharttils.config.pingDisplay != 0
