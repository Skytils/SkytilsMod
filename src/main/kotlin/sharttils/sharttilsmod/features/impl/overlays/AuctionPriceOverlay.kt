 ...
 */
package sharttils.sharttilsmod.features.impl.overlays
...
import sharttils.sharttilsmod.mixins.transformers.accessors.AccessorGuiEditSign
...
class AuctionPriceOverlay {
    ...
    fun onGuiOpen(event: GuiOpenEvent) {
        if (!Utils.inSkyblock || !Sharttils.config.betterAuctionPriceInput) return
