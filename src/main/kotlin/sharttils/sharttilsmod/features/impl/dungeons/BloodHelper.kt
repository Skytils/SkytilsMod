...
object BloodHelper {
    val watcherSkins = setOf(
        ...
        "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWZkNjFlODA1NWY2ZWU5N2FiNWI2MTk2YThkN2VjOTgwNzhhYzM3ZTAwMzc2MTU3YjZiNTIwZWFhYTJmOTNhZiJ9fX0="
    )
    ...
    fun render(event: RenderWorldLastEvent) {
        if (!Utils.inDungeons || DungeonTimer.bloodOpenTime == -1L || DungeonTimer.bloodClearTime != -1L || !Sharttils.config.bloodHelper) return
        ...
        mobs.also {
            ...
            .forEachIndexed { index, (_, mob) ->
                RenderUtil.drawOutlinedBoundingBox(
                    ...
                    Sharttils.config.bloodHelperColor,
                    1f,
                    event.partialTicks
                )
