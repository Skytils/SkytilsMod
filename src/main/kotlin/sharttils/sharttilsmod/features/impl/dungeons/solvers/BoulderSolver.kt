...
class BoulderSolver {
    ...
    fun onRenderWorld(event: RenderWorldLastEvent) {
        if (!Sharttils.config.boulderSolver || !DungeonListener.missingPuzzles.contains("Boulder")) return
                    ...
                    if (boulderChest == null || boulderFacing == null) {
                        ...
                        if (roomVariant == -1) {
                            ...
                            while (i < expectedBoulders.size) {
                                ...
                                if (isRight) {
                                    roomVariant = i
                                    UChat.chat("§aSharttils detected boulder variant ${roomVariant + 1}.")
                                    break
                                }
                                i++
                            }
                            if (roomVariant == -2) {
                                UChat.chat("§cSharttils couldn't detect the boulder variant.")
                            }
                        }
                    }
                }
