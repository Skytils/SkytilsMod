...
object SelectAllColorSolver {
    ...
    fun onBackgroundDrawn(event: GuiContainerEvent.BackgroundDrawnEvent) {
        if (!Utils.inDungeons || !Sharttils.config.selectAllColorTerminalSolver || event.container !is ContainerChest) return
    ...
    fun onDrawSlot(event: GuiContainerEvent.DrawSlotEvent.Pre) {
        ...
        if (!Sharttils.config.selectAllColorTerminalSolver) return
