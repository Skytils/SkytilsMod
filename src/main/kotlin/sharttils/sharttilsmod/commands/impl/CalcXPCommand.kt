...
object CalcXPCommand : BaseCommand("sharttilscalcxp") {
    ...
    override fun processCommand(player: EntityPlayerSP, args: Array<String>) {
        ...
        val xpMap = when {
            ...
            type == "skill" -> SkillUtils.skillXp
                ...
                UChat.chat("§9§lSharttils ➜ §cThat skill is unknown to me!")
                return
            }
        }
        ...
        UChat.chat("§9§lSharttils ➜ §bYou need §6${NumberUtil.nf.format(sum)}§b to get from §6$type§b level §6${starting}§b to level §6$ending§b!")
    }
}