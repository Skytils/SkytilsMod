...
import sharttils.hylin.extension.getString
import sharttils.hylin.player.Player
import sharttils.hylin.player.rank.PackageRank
import sharttils.hylin.skyblock.Pet
import sharttils.hylin.skyblock.item.Tier
import sharttils.sharttilsmod.Sharttils
import sharttils.sharttilsmod.Sharttils.Companion.mc
import sharttils.sharttilsmod.asm.SharttilsTransformer
...
import sharttils.sharttilsmod.utils.graphics.colors.ColorFactory.web
import sharttils.sharttilsmod.utils.graphics.colors.CustomColor
import sharttils.sharttilsmod.utils.graphics.colors.RainbowColor.Companion.fromString
...
fun Vigilant.openGUI(): Future<*> = Sharttils.threadPool.submit {
    Sharttils.displayScreen = this.gui()
}
...
val MethodInsnNode.descriptor: Descriptor
    get() = Descriptor(
        ...
        SharttilsTransformer.methodMaps.getOrSelf(AsmHelper.remapper.remapMethodName(this.owner, this.name, this.desc)),
