...
object APIUtil {
    ...
    val builder: HttpClientBuilder =
        HttpClients.custom().setUserAgent("Sharttils/${Sharttils.VERSION}")
    ...
    fun URL.getImage(): BufferedImage {
        ...
        connection.addRequestProperty("User-Agent", "Sharttils/${Sharttils.VERSION}")
    ...
    fun getJSONResponse(urlString: String): JsonObject {
        ...
        try {
            ...
            ex.printStackTrace()
            UChat.chat("§cSharttils ran into an ${ex::class.simpleName ?: "error"} whilst fetching a resource. See logs for more details.")
        } finally {
            client.close()
        }
        return JsonObject()
