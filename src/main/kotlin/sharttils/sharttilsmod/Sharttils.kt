...
package sharttils.sharttilsmod
...
import sharttils.hylin.HylinAPI.Companion.createHylinAPI
import sharttils.sharttilsmod.commands.impl.*
import sharttils.sharttilsmod.commands.stats.impl.CataCommand
import sharttils.sharttilsmod.commands.stats.impl.SlayerCommand
import sharttils.sharttilsmod.core.*
import sharttils.sharttilsmod.events.impl.MainReceivePacketEvent
import sharttils.sharttilsmod.events.impl.PacketEvent
import sharttils.sharttilsmod.features.impl.dungeons.*
import sharttils.sharttilsmod.features.impl.dungeons.solvers.*
import sharttils.sharttilsmod.features.impl.dungeons.solvers.terminals.*
import sharttils.sharttilsmod.features.impl.events.GriffinBurrows
import sharttils.sharttilsmod.features.impl.events.MayorDiana
import sharttils.sharttilsmod.features.impl.events.MayorJerry
import sharttils.sharttilsmod.features.impl.events.TechnoMayor
...
import sharttils.sharttilsmod.features.impl.handlers.*
import sharttils.sharttilsmod.features.impl.mining.DarkModeMist
import sharttils.sharttilsmod.features.impl.mining.MiningFeatures
import sharttils.sharttilsmod.features.impl.mining.StupidTreasureChestOpeningThing
import sharttils.sharttilsmod.features.impl.misc.*
import sharttils.sharttilsmod.features.impl.overlays.AuctionPriceOverlay
import sharttils.sharttilsmod.features.impl.protectitems.ProtectItems
import sharttils.sharttilsmod.features.impl.spidersden.RainTimer
import sharttils.sharttilsmod.features.impl.spidersden.RelicWaypoints
import sharttils.sharttilsmod.features.impl.spidersden.SpidersDenFeatures
import sharttils.sharttilsmod.features.impl.trackers.impl.DupeTracker
import sharttils.sharttilsmod.features.impl.trackers.impl.MayorJerryTracker
import sharttils.sharttilsmod.features.impl.trackers.impl.MythologicalTracker
import sharttils.sharttilsmod.gui.OptionsGui
import sharttils.sharttilsmod.gui.ReopenableGUI
import sharttils.sharttilsmod.listeners.ChatListener
...
import sharttils.sharttilsmod.mixins.transformers.accessors.AccessorCommandHandler
import sharttils.sharttilsmod.mixins.transformers.accessors.AccessorGuiStreamUnavailable
import sharttils.sharttilsmod.mixins.transformers.accessors.AccessorSettingsGui
...
@Mod(
    modid = Sharttils.MODID,
    name = Sharttils.MOD_NAME,
    version = Sharttils.VERSION,
...
class Sharttils {
    ...
    companion object : CoroutineScope {
        const val MODID = "sharttils"
        const val MOD_NAME = "Sharttils"
        ...
        @JvmField
        val modDir = File(File(mc.mcDataDir, "config"), "sharttils")
    ...
    fun postInit(event: FMLPostInitializationEvent) {
        ...
        if (cch !is AccessorCommandHandler) throw RuntimeException("Sharttils was unable to mixin to the CommandHandler. Please report this on our Discord at discord.gg/sharttils.")
        cch.registerCommand(SharttilsCommand)
        ...
        cch.commandMap["sharttilsreparty"] = RepartyCommand
    ...
    fun onPacket(event: MainReceivePacketEvent<*, *>) {
        ...
        if (event.packet is S1CPacketEntityMetadata && mc.thePlayer != null) {
            ...
            if (entity is ExtensionEntityLivingBase) {
                entity.sharttilsHook.onNewDisplayName(nameObj.`object` as String)
            }
        }
    ...
    fun onGuiInitPost(event: GuiScreenEvent.InitGuiEvent.Post) {
        if (config.configButtonOnPause && event.gui is GuiIngameMenu) {
            ...
            event.buttonList.add(GuiButton(6969420, x, 0.coerceAtLeast(y), 100, 20, "Sharttils"))
        }
    }
