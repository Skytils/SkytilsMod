...
class WitherEssenceToast(private val player: String) : IToast<WitherEssenceToast> {
    ...
    override fun draw(toastGui: GuiToast, delta: Long): IToast.Visibility {
        ...
        toastGui.mc.fontRendererObj.drawStringWithShadow("§7Wither Essence", 30f, 7f, 16777215)
        GuiToast.drawSubline(toastGui, delta, 0L, maxDrawTime, buffer, player, false)
        RenderHelper.enableGUIStandardItemLighting()
        RenderUtil.renderTexture(WITHER, 8, 8)
    ...
    companion object {
        ...
        private val WITHER = ResourceLocation("skytils:toasts/essences/wither.png")
    }
