        ...
        if (Skytils.config.showItemQuality && extraAttr != null) {
            ...
            if (boost > 0) {
                val floor = when {
                    ...
                    req == "CATACOMBS:24" && tier == 4 -> "§aM1"
                    req == "CATACOMBS:26" && tier == 5 -> "§aM2"
                    req == "CATACOMBS:28" && tier == 6 -> "§aM3"
                    req == "CATACOMBS:30" && tier == 7 -> "§aM4"
                    req == "CATACOMBS:32" && tier == 8 -> "§aM5"
                    req == "CATACOMBS:34" && tier == 9 -> "§aM6"
                    req == "CATACOMBS:36" && tier == 10 -> "§aM7"
                    else -> "§b$tier"
                }
